...
const NewOrEditEvent = ({
  ...
  const [errors] = useState([]); // eslint-disable-line
  // const [startDate, handleStartDateChange] = useState(selectedDate); // eslint-disable-next-line
  // const [endDate, handleEndDateChange] = useState(new Date(selectedDate)); // eslint-disable-next-line
  // const [status, setStatus] = React.useState("R"); // eslint-disable-next-line
